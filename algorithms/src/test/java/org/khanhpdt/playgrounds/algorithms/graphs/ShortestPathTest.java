...
public class ShortestPathTest {
	...
	public static final double DOUBLE_ERROR = 0.0001;
	...
	public void testSingleSourceShortestPath_distance() throws Exception {
		...
		assertThat(shortestPath.distanceTo(graph.getVertex(1)), closeTo(2, DOUBLE_ERROR));
		assertThat(shortestPath.distanceTo(graph.getVertex(2)), closeTo(4, DOUBLE_ERROR));
		assertThat(shortestPath.distanceTo(graph.getVertex(3)), closeTo(-2, DOUBLE_ERROR));
		assertThat(shortestPath.distanceTo(graph.getVertex(4)), closeTo(7, DOUBLE_ERROR));
	}
}
